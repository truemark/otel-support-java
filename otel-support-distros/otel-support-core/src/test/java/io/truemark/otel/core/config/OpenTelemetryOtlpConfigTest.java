...
public class OpenTelemetryOtlpConfigTest {
    ...
    public void setUp() {
        ...
        otelSetupData = new OpenTelemetrySetupData(serviceConfig, otlpConfig, tracingConfig, meterConfig, loggingConfig);
    }
    ...
    public void test_OpenTelemetryOtlpConfigConstructor_givenVaryingConfigInputs(boolean otlpEnabled, boolean tracingEnabled, boolean batchingEnabled, boolean meterEnabled, boolean loggingEnabled) {
