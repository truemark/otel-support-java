...
class OtelServiceConfigDataTest {

  @ParameterizedTest
  @CsvSource({"test-service, 1.0.0", "another-service, 2.1.3"})
  void test_OtelServiceConfigDataConstructorAndGetters_givenValidInputs(
  ...
  void test_OtelServiceConfigDataConstructor_givenInvalidInputs(
      String serviceName, String serviceVersion) {
    assertThrows(
