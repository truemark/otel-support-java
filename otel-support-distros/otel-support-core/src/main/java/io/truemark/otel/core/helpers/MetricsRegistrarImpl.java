...
public class MetricsRegistrarImpl implements MetricsRegistrar {
    ...
    private static final String UPDOWN_COUNTER_NOT_REGISTERED = "UpDownCounter with name %s not registered.";
    ...
    @Override
    public LongUpDownCounter registerUpDownCounter(String counterName, String description, String unit) {
        return upDownCounters.computeIfAbsent(counterName, name ->
    ...
    @Override
    public DoubleHistogram registerDoubleHistogram(String histogramName, String description, String unit, List<Double> bucketBoundaries) {
        final DoubleHistogramBuilder builder = meter.histogramBuilder(histogramName)
                .setDescription(description)
                .setUnit(unit);
    ...
    @Override
    public LongHistogram registerLongHistogram(String histogramName, String description, String unit, List<Long> bucketBoundaries) {
        final LongHistogramBuilder builder = meter.histogramBuilder(histogramName)
                .setDescription(description)
                .setUnit(unit)
                .ofLongs();
        if (bucketBoundaries != null && !bucketBoundaries.isEmpty()) {
    ...
    @Override
    public void registerLongGauge(String gaugeName, String description, String unit, Supplier<Long> valueSupplier) {
        try (ObservableLongGauge gauge = meter.gaugeBuilder(gaugeName)
                .setDescription(description)
                .setUnit(unit)
                .ofLongs()
    ...
    @Override
    public void registerDoubleGauge(String gaugeName, String description, String unit, Supplier<Double> valueSupplier) {
        try (ObservableDoubleGauge gauge = meter.gaugeBuilder(gaugeName)
                .setDescription(description)
                .setUnit(unit)
                .buildWithCallback(observableMeasurement -> {
