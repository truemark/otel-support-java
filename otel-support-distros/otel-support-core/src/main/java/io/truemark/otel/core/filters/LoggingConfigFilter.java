...
public class LoggingConfigFilter implements OpenTelemetryConfigFilter {

  private static final Logger log = Logger.getLogger(LoggingConfigFilter.class.getName());
